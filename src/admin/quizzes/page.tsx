            ...
            <div className="w-full">
                ...
                <div className="quizzes-header">
                    ...
                    <div className="quizzes-button-group">
                        <Link to="/">
                            <Button size="sm" className={"back-btn"}>← Back</Button>
                        </Link>
                    </div>
                </div>
                                ...
                                <div className="quiz-card-content">
                                    <div className="quiz-card-info">
                                        ...
                                        <div className="quiz-card-meta">
                                            <span className={"date-num"}>{quiz.questions.length} questions</span>
                        ...
                        Created {new Date(quiz.createdAt).toLocaleDateString()}
                                        ...
                                        <div className="quiz-card-actions">
                                            <Link to={`/admin/quizzes/${quiz.id}`}>
                                                <Button size="sm" className={"card-btn"}>Edit</Button>
                                            </Link>
                                            <Link to={`/admin/host?quiz=${quiz.id}`}>
                                                <Button size="sm" className={"card-btn"}>Host</Button>
                                            </Link>
                                            <Button
                                                size="sm"
