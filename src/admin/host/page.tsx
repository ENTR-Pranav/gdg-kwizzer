        ...
        <div className="host-setup-container">
            <div className="host-setup-wrapper">
                ...
                <div className="host-setup-header">
                    ...
                    <Link to="/admin/quizzes">
                        <Button size="sm" className={"back-btn white-text"}>← Back</Button>
                    </Link>
                </div>

                {/* Quiz Info Card */}
                <div className={"glass-container-host"}>
                ...
                <span className="host-quiz-badge">
                  ...
                  By {user?.displayName || user?.email}
                    ...
                    {/* Game Settings Card */}
                    <Card variant="default" padding="lg" className="host-setup-card glass-container-host">
...
function GameHost({game, quiz}: { game: Game; quiz: Quiz }) {
    ...
    if (currentGame.phase === "ended") {
        return (
            <div className="host-center-container-leaderboard">
