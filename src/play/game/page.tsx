    ...
    if (game.phase === "lobby") {
        return (
            <div className="game-lobby-container">
                <div className={"game-lobby-glass-container"}>
                ...
                <div className="game-question-wrapper">
                    ...
                    {selectedAnswer !== null && !answerSubmitted && (
                        <div className="game-submit-section">
                            <Button onClick={submitAnswer} className="w-full max-w-xs create-card-btn">
                                Submit Answer
                            </Button>
                        </div>
                    )}
        ...
        return (
            <div className="game-results-container">
                <div className="game-results-wrapper">
                    ...
                    {/* Show leaderboard */}
                    <div className={"glass-container-gamepage"}>
            ...
            <div className="game-over-container">
                <div className="game-over-wrapper">
                    ...
                    <div className="game-over-action">
                        <Button onClick={() => navigate("/")} className="w-full max-w-xs back-btn">
                            Back to Home
                        </Button>
                    </div>
                </div>
